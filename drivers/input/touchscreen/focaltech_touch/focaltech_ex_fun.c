...
{
    return fts_i2c_write_reg(fts_data->client, FTS_REG_POWER_MODE, FTS_REG_POWER_MODE_SLEEP_VALUE);;
}
...
static DEVICE_ATTR(fts_get_fw_version, S_IRUGO | S_IWUSR, fts_tpfwver_show, fts_tpfwver_store);
