...
*
*    Author: Focaltech Driver Team // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
*
*   Created: 2016-08-03
*
...
*  Return:
*****************************************************************************/
static int fts_esdcheck_tp_reset(struct fts_ts_data *ts_data) // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
{
    FTS_FUNC_ENTER();
    ...
    fts_reset_proc(200);
    fts_tp_state_recovery(ts_data->client); // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
...
static bool get_flow_cnt(struct fts_ts_data *ts_data)
{
    ...
    if (fts_esdcheck_data.flow_work_hold_cnt >= 5) { // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
...
{
    /* interrupt don't add debug message */
    return fts_esdcheck_data.mode; // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
}
...
*  Return:
*****************************************************************************/
int fts_esdcheck_exit(struct fts_ts_data *ts_data) // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
{
    FTS_FUNC_ENTER();
