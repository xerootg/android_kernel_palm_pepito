...
*/
struct fts_gesture_st { // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
...
int fts_create_gesture_sysfs(struct i2c_client *client)
{
    ...
    if ( ret != 0) { // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
...
/************************************************************************
*   Name: fts_gesture_read_buffer // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
...
{
    if (fts_gesture_data.mode == ENABLE) { // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
...
int fts_gesture_init(struct fts_ts_data *ts_data)
{
    ...
    fts_gesture_data.mode = ENABLE; // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
