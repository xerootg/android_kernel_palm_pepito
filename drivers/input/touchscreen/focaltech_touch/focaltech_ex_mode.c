...
*****************************************************************************/
struct fts_mode_flag { // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
...
* Return: success >=0, otherwise failed
***********************************************************************/
int  fts_enter_cover_mode( struct i2c_client *client, int mode) // MODIFIED by junwen.ye, 2017-11-21,BUG-5628800
{
    int ret = 0;
    static u8 buf_addr[2] = { 0 };
    static u8 buf_value[2] = { 0 };
