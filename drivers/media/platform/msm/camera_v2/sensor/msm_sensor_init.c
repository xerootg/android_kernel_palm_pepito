...
{
	int rc = 0;
	//int tm = 20000;//modify by qiurongzhang for fix invalid camera ID 20180518
	if (s_init->module_init_status == 1) {
		CDBG("msm_cam_get_module_init_status -2\n");
		return 0;
	}
	//modify start by qiurongzhang for fix invalid camera ID 20180518
        /*
	...
	//modify End by qiurongzhang for fix invalid camera ID 20180518
	return rc;
}
